...
function onGameReady()
	...
	local oo2 = ResolutionHauteur(870)
	local ii2 = ResolutionLargeur(30*GeneratedBumper2())
	local uu2 = ResolutionHauteur(4*GeneratedBumper())
	local pp3 = ResolutionLargeur(200*GeneratedBumper())
	local oo3 = ResolutionHauteur(570)
	local oo4 = ResolutionHauteur(270)
	local ii3 = ResolutionLargeur(30*GeneratedBumperLargeur())
	local uu3 = ResolutionHauteur(4*GeneratedBumper())
