...
function createBall()
	local ballBody = createBody(i, "Circle", 0.001, 0.01, 0.9,false,WINDOW_WIDTH/2, 500, {20, 0})
	local ball = createSprite("assets/Balle.png", 45, 45, 0,0)
...
function onEngineRender()
	...
	victory = false
	local v =createText("Victory !","assets/Fonts/CHILLER.TTF", 255, 700, 400, 255, 0, 0)
	end
	if NbGoalRed == 10 and victory == true then
	victory = false
	local d =createText("Victory !","assets/Fonts/CHILLER.TTF", 255, 700, 400, 0, 0, 255)
	end
